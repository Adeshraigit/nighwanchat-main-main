      ...
      <div className="custom-container">
        ...
        <div className="services-list">
          ...
          <div className="service-card simple-shadow">
            ...
            <h3>
              <Link to="/service-details">Woo Commerce</Link>
            </h3>
          ...
          <div className="service-card simple-shadow">
            ...
            <h3>
              <Link to="/service-details">CRM Solutions</Link>
            </h3>
          ...
          <div className="service-card simple-shadow">
            ...
            <h3>
              <Link to="/service-details">Hardware Services</Link>
            </h3>
          ...
          <div className="service-card simple-shadow">
            ...
            <h3>
              <Link to="/service-details">Monitoring</Link>
            </h3>
            <p>We enhance customer experiences for success.</p>
          </div>
          <div className="service-card simple-shadow">
            ...
            <h3>
              <Link to="/service-details">Email Services</Link>
            </h3>
            <p>We create vibrant, intuitive and minimalist web</p>
          </div>
          <div className="service-card simple-shadow">
            ...
            <h3>
              <Link to="/service-details">IT Support</Link>
            </h3>
            <p>We offers expert assistance for your IT issues.</p>
          </div>
        </div>
